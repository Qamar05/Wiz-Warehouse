...
import com.vms.wizwarehouse.databinding.FragmentDistributerDetailsBinding
import com.vms.wizwarehouse.distribute_inventory.DistributeInventoryActivity
import com.vms.wizwarehouse.distribute_inventory.distributed_inventory.DistributeInventoryFragment
import com.vms.wizwarehouse.utils.Utility
import java.io.IOException
import java.util.Locale

class DistributeDetailsFragment : Fragment() {
    private lateinit var _binding: FragmentDistributerDetailsBinding
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDistributerDetailsBinding.inflate(inflater, container, false)
...
//            }
            ...
            parentFragmentManager.beginTransaction()
                .replace(R.id.frame_layout, DistributeInventoryFragment())
