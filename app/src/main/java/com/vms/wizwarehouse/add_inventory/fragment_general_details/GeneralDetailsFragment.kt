package com.vms.wizwarehouse.add_inventory.fragment_general_details
...
import com.vms.wizwarehouse.add_inventory.fragment_product_details.ProductDetailsFragment
import com.vms.wizwarehouse.databinding.FragmentInventoryGeneralDetailsBinding
...
class GeneralDetailsFragment : Fragment() {
    private var _binding: FragmentInventoryGeneralDetailsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentInventoryGeneralDetailsBinding.inflate(inflater, container, false)
        ...
        receiverAdapter = ImagePreviewAdapter(requireContext(), receiverImages, object : ImagePreviewAdapter.OnImageRemoveListener {
            override fun onRemove(position: Int) {
                receiverImages.removeAt(position)
                receiverAdapter.notifyItemRemoved(position)
            }
        })
        ...
        invoiceAdapter = ImagePreviewAdapter(requireContext(), invoiceImages, object : ImagePreviewAdapter.OnImageRemoveListener {
            override fun onRemove(position: Int) {
                invoiceImages.removeAt(position)
...
//            }
            ...
            parentFragmentManager.beginTransaction()
                .replace(R.id.frame_layout, ProductDetailsFragment())
